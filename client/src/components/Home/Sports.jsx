      ...
      <div className="z-10 h-full w-full md:w-1/2 flex flex-col items-center justify-center">
        {selectedContent && (
          <div className=" flex flex-col">
            <motion.h2
              className="  flex justify-center  font-dharma font-extrabold text-[30.88vw] md:text-[9.92vw]   relative top-[-35vh] md:top-[-28vh] lg:top-[-30vh]  md:left-[47.39vw] leading-[9.51vw] tracking-wide"
